...
export default function InvestorReportCards() {
  return (
    <section className="grid xl:grid-cols-4 lg:grid-cols-2 grid-cols-1 gap-[2rem] mb-[2.5rem]">
			...
			{/* item- 2  */}
			<div className="shadow-custom p-[1.25rem] bg-white">
				<h3 className="text-[#858585] font-semibold mb-3">Active Investors</h3>
				<div className="flex justify-between items-center">
			...
			{/* item- 3  */}
			<div className="shadow-custom p-[1.25rem] bg-white">
				<h3 className="text-[#858585] font-semibold mb-3">Inactive Investors</h3>
				<div className="flex justify-between items-center">
