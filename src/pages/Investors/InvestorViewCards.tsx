		...
		<>
			...
			<section className='mb-[2.5rem]'>
				<div className="flex flex-wrap gap-[1rem] mb-[1rem]">
					<img
						className="md:w-[200px] w-full h-[155px]"
						src={profilePhoto}
						alt="Invesotr Image"
					/>
				...
				<div className='grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5'>
					...
					<div>
						<h5 className='text-[#8B8D97] text-[14px]'>Last Investment Date:</h5>
				...
				<div className='bg-white shadow-custom p-[1rem] max-w-[600px]'>
				<div className='flex md:items-center md:justify-between md:flex-row flex-col md:gap-0 gap-3'>
					...
					<div>
						...
						<p className='text-[14px]'>Created on <span className='font-medium'>10 Jan 2024</span></p>
					</div>
